...
export function KeyPersonnelItem({
  ...
  const imgSrc = useMemo(() => {
    if (jobTitle === "项目经理") {
      return "/dashboard-assets/schema-component/KeyPersonArrived/xmjl.png";
    }
    if (jobTitle === "专职安全员") {
      return "/dashboard-assets/schema-component/KeyPersonArrived/zzaqy.png";
    }

    return "/dashboard-assets/schema-component/KeyPersonArrived/zj.png";
  }, [jobTitle]);
